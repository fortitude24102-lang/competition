...
module ram_16x220(	// src/main/scala/chisel3/util/Queue.scala:73:91
  input  [3:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  output [219:0] R0_data,
  input  [3:0]   W0_addr,
  input          W0_en,
                 W0_clk,
  input  [219:0] W0_data
  ...
  reg [219:0] Memory[0:15];	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  `ifdef ENABLE_INITIAL_MEM_	// src/main/scala/chisel3/util/Queue.scala:73:91
    reg [223:0] _RANDOM_MEM;	// src/main/scala/chisel3/util/Queue.scala:73:91
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:91
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          ...
          Memory[i[3:0]] = _RANDOM_MEM[219:0];	// src/main/scala/chisel3/util/Queue.scala:73:91
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 220'bx;	// src/main/scala/chisel3/util/Queue.scala:73:91
endmodule
