...
module ram_256x39(	// src/main/scala/chisel3/util/Queue.scala:73:91
  input  [7:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [38:0] R0_data,
  ...
  reg [38:0] Memory[0:255];	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:91
        for (logic [8:0] i = 9'h0; i < 9'h100; i += 9'h1) begin
          ...
          Memory[i[7:0]] = _RANDOM_MEM[38:0];	// src/main/scala/chisel3/util/Queue.scala:73:91
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 39'bx;	// src/main/scala/chisel3/util/Queue.scala:73:91
endmodule
