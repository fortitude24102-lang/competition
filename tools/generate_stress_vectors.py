...
body=b''.join(d+b for d,b in zip(desc,rec)); hdr=struct.pack('<4sHHHHIII I',b'SVEC',1,32,16,32,len(tiers),0x20260921,sum(len(x)//32 for x in rec),zlib.crc32(body)&0xffffffff,0)
